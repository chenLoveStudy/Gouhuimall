# 家电销售平台
迷你家电销售平台是一个基于SSM框架的综合性B2C电商平台，需求设计主要参考家电销售平台的购物流程：用户从注册开始，到完成登录，浏览商品，加入购物车，进行下单，确认收货，评价等一系列操作。
作为模拟家电销售平台系统的核心组成部分之一，采用SSM框架的家电销售平台管理后台包含商品管理，订单管理，类别管理，用户管理和交易额统计等模块，实现了对整个商城的一站式管理和维护。
（仅供参考，如有问题还请见谅！）
